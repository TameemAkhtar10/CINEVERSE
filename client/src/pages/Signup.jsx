        ...
        <div className="min-h-screen bg-bg flex items-center justify-center px-4 animate-fade-in relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-card border border-white/[0.08] rounded-2xl p-8 space-y-6">
                <div className="text-center space-y-1">
                    ...
                    <p className="text-text-secondary text-sm">Join CINEVERSE today</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label className="text-text-secondary text-xs font-semibold uppercase tracking-wide block mb-1.5">Name</label>
                        <input
                            type="text"
                            name="name"
                            value={form.name}
